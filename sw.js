'use strict';
const CACHE = 'pmp-study-hub-cf366ca2ae79d08e';
const ASSETS = ['./','./index.html','./styles.css','./config.js','./core.js','./learning.js','./study.js','./app.js','./icon.svg','./manifest.webmanifest', ...[1,2,3,4,5,6].map(n=>'./content/pack-'+String(n).padStart(2,'0')+'.json')];
